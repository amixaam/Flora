    ...
    <ScrollView style={mainStyles.container}>
      ...
      <View style={{ flex: 1, gap: Spacing.appPadding }}>
        ...
        <View style={{ gap: Spacing.sm }}>
          ...
          <CategoriesSelector buttons={["Sleep", "Focus", "Energize", "sad"]} />
        </View>
        <HorizontalList list={albums} />
        {/* <HomeHeader text="Most played" />
                <HomeHeader text="Recaps" /> */}
      </View>
      <View style={{ paddingBottom: insets.bottom + Spacing.miniPlayer }} />

      <PlaylistSheet
        ref={PlaylistOptionsRef}
        dismiss={dismissPlaylistOptions}
      />
      <CreatePlaylist ref={CreatePlaylistRef} dismiss={dismissCreatePlaylist} />
    </ScrollView>
  );
}
        ...
        >
          ...
          >
            ...
            <Text style={textStyles.small}>
              Find out what you’ve been listening to for the last month!
            </Text>
          </View>
    ...
    <TouchableNativeFeedback delayLongPress={250} {...touchableProps}>
      <View style={{ gap: Spacing.xs, width: width }}>
        ...
        <View>
          ...
          <Text style={[textStyles.small, { width: "100%" }]} numberOfLines={1}>
