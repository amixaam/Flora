...
import MusicInfoResponse from "expo-music-info-2/MusicInfo";
...
class MusicInfoLoader {
    constructor(fileUri, options) {
        ...
        this.options = options
            ? {
                  ...
                  year: options.year ? options.year : true,
        ...
        if (this.options.year == true) this.expectedFramesNumber++;
    ...
    async loadFileToBuffer() {
        ...
        this.buffer.setData(
            Uint8Array.from(Base64.decode(data), (c) => c.charCodeAt(0))
        );
    ...
    async loadInfo() {
        ...
        try {
            ...
            if (this.options.year && this.frames[YEAR_TOKEN])
                result.year = this.frames[YEAR_TOKEN];
    ...
    async processPictureFrame(frameSize) {
        ...
        this.frames[PICTURE_TOKEN] = {
            ...
            pictureData:
                ...
                mimeType +
                ";base64," +
                this.bytesToBase64(pictureData),
        };
    }
